...
третьей всего одна сессия, и машина с трассой в этих записях не разделены (Ferrari ездил
только Road Atlanta, SF Lights только Road America) — любой эффект можно с
равным правом приписать трассе. Половина реального пробега (303 круга на
