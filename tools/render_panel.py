...
def main():
    ...
    # Здесь код 1, в отличие от render_dashboard: панель рисует Qt, а не
    # внешний браузер. Исключение отсюда — сломанный виджет, то есть ровно
    # то, ради чего проверка и заведена.
